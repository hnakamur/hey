...
var (
	...
	randomRequestIDQuery = flag.String("random-request-id-query", "", "")
)
...
Options:
  ...
  -random-request-id-query  Add random request ID query parameter with the specified name.
`
...
func main() {
	...
	w := &requester.Work{
		...
		ProxyAddr:            proxyURL,
		Output:               *output,
		RandomRequestIDQuery: *randomRequestIDQuery,
	}
	w.Init()
